...
return [
    'modules' => [
        ...
        'Aalogics_AttributeOptions' => 1,
        'BitExpert_ForceCustomerLogin' => 1,
        'Bss_CustomProductAttributeExport' => 1,
        'Ecomteck_Core' => 1,
        'Ecomteck_CustomAttributeManagement' => 1,
        'Ecomteck_CustomerCustomAttributes' => 1,
        'Ecomteck_StoreLocator' => 1,
        'Ecomteck_StorePickup' => 1,
        'MGS_Brand' => 1,
        'Hdweb_Core' => 1,
        'Hdweb_Enquiry' => 1,
        'Hdweb_GenerateUrl' => 1,
        'Hdweb_HyvaCheckoutVehicleInfo' => 1,
        'Hdweb_HyvaCurrency' => 1,
        'Hdweb_Installer' => 1,
        'Hdweb_Purchaseorder' => 1,
        'Hdweb_Rfc' => 1,
        'Hdweb_Specialoffers' => 1,
        'Hdweb_Tyrefinder' => 1,
        'Hdweb_Vehicles' => 1,
        'Hdweb_WarrantyClaim' => 1,
        'Hyva_Theme' => 1,
        ...
        'Klever_AbandonedMail' => 1,
        'Mageplaza_Core' => 1,
        'Klever_BrandSegment' => 1,
        'Klever_BrandSync' => 1,
        'Hyva_Checkout' => 1,
        'Klever_CustomCart' => 1,
        'MGS_Blog' => 1,
        'Mageprince_Faq' => 1,
        'Klever_OrderActions' => 1,
        'Klever_Sitemap' => 1,
        'Tamara_Checkout' => 1,
        'Klever_VehicleTyresGuide' => 1,
        'MGS_Ajaxlayernavigation' => 1,
        'Smile_ElasticsuiteCatalog' => 1,
        'Hdweb_Brandoveride' => 1,
        'Mageplaza_BannerSlider' => 1,
        'Klever_BannerSlider' => 1,
        'Mageplaza_GoogleRecaptcha' => 1,
        'Mageplaza_Smtp' => 1,
        'Mageplaza_SocialLogin' => 1,
        'Klever_Faq' => 1,
        'Klever_CheckoutCityDropdown' => 1,
        'Meetanshi_OrderNumber' => 1,
        'Mgt_Varnish' => 1,
        'Mirasvit_Core' => 1,
        ...
        'Tabby_Checkout' => 1,
        'Tabby_Feed' => 1,
        'Klever_TamaraTitle' => 1,
        'TotalPay_Gateway' => 1,
        'Webcastle_CategoryImportExport' => 1,
        'WeltPixel_Backend' => 1,
        'WeltPixel_GA4' => 1,
        'WeltPixel_HyvaGA4' => 1
    ],
