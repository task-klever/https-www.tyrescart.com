...
class Export extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        ini_set('memory_limit', '2G');         // allow up to 2 GB memory
        ini_set('max_execution_time', 1800);  // 30 minutes, adjust as needed
        ...
        foreach ($collection as $key => $cat) {
            ...
            if ($cat->getId()>=2) {
                ...
                if ($categoryitem->getId()) {
                    ...
                    //$content .= $categoryitem->getName().'","'.$categoryitem->getId().'","","","","","","","","","","","","","","","","","",""'."\n";
      ...
      return  $this->fileFactory->create(
        $fileName,
        $content,
        \Magento\Framework\App\Filesystem\DirectoryList::VAR_DIR, // storage location
        'text/csv'
        );
