...
define([
    ...
    $.widget("mage.ajaxnavigation", {
      ...
      applyFilter: function (el) {
        ...
        $(".filter-option-search input").val(""); // Reset search input value
        this.initSearch();
      },
          ...
          .done(function (data) {
            if (data.list) {
              if ($("body").hasClass("page-layout-1column")) {
                $(".product-container.category-product-container").replaceWith(
                  data.list
                );
                ...
                $(".products").replaceWith(data.list);
            ...
            if (data.filters) {
              ...
              $(".page-layout-1column .category-product-actions").prepend(
                data.filters
              );
            }
            self.url = url;
