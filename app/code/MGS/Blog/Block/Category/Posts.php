...
class Posts extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($pageTitle == 'Tyres') {
            $pageTitle = 'Tyre Tips, Care Guides & Buying Advice | TyresCart';
        } elseif ($pageTitle == 'Battery') {
            $pageTitle = 'Car Battery Care, Tips & Replacement Guide | TyresCart';
        } elseif ($pageTitle == 'Oil Change') {
            $pageTitle = 'Oil Change Tips, Maintenance & Engine Care | TyresCart';
        } elseif ($pageTitle == 'Car Service') {
            $pageTitle = 'Car Service Tips, Repair Guides & Maintenance | TyresCart';
        } elseif ($pageTitle == 'News') {
            $pageTitle = 'Auto News, Tyre Updates & Industry Trends | TyresCart';
        }
