...
class GetTireBrands extends Action
{
    ...
    public function execute()
    {
        ...
        foreach ($brandCollection as $brand) {
            ...
            $selectHtml .= '<li class="search" data-name="' . strtolower($escapedName) . '">
                <div onclick="selectTireBrand(\'' . $optionId . '\', \'' . addslashes($name) . '\', \'' . addslashes($urlKey) . '\')">
                    <a href="javascript:void(0)" class="block text-center" title="' . $escapedName . '" id="brand-' . $urlKey . '">
                    ' . $imageHtml . '
