...
class Rimrepairservice extends Action
{
    ...
    public function execute()
    {
        ...
        if ($request->isPost()) {
            ...
            try {
                ...
                $enquiry->setFormType('Rim Repair Service'); // you can set any form type name
                $enquiry->setStatus(1);
                $enquiry->save();
                ...
                $this->messageManager->addSuccessMessage(__('Thank you for book online! We will contact you soon.'));
				
				$objectManager = \Magento\Framework\App\ObjectManager::getInstance();
$storeManager = $objectManager->get('\Magento\Store\Model\StoreManagerInterface');
$baseUrl = $storeManager->getStore()->getBaseUrl();

                return $this->_redirect($baseUrl.'rim-repair-service');
            } catch (\Exception $e) {
    ...
    protected function sendEmail($postData)
    {
        try {
            ...
            file_put_contents(BP . '/var/log/rimrepair_email_error.log', $e->getMessage(), FILE_APPEND);
        }
    }
}
