...
namespace TotalPay\Gateway\Helper;

/**
 * Helper Class for all Payment Methods
 *
 * Class Data
 * @package TotalPay\Gateway\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const CODE = 'TotalPay_Gateway';
     ...
     * @param \TotalPay\Gateway\Model\ConfigFactory $configFactory,
    ...
    public function __construct(
        ...
        \TotalPay\Gateway\Model\ConfigFactory $configFactory,
     ...
     * @return \TotalPay\Gateway\Model\ConfigFactory
     */
    ...
    //    //error_log($paymentMethod.print_r($transactionType,true));
