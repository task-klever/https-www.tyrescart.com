 ...
 */
namespace Ecomteck\CustomerCustomAttributes\Controller\Adminhtml\Customer\Address;
...
abstract class Attribute extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Ecomteck_CustomerCustomAttributes::customer_address_attributes';
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu(
            'Ecomteck_CustomerCustomAttributes::customer_attributes_customer_address_attributes'
        )->_addBreadcrumb(
            __('Customer'),
            __('Customer')
        )->_addBreadcrumb(
