...
abstract class AbstractSales extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     *
     * @param \Ecomteck\CustomerCustomAttributes\Model\Sales\AbstractSales $sales
     * @return bool
     */
    public function isEntityExists(\Ecomteck\CustomerCustomAttributes\Model\Sales\AbstractSales $sales)
    {
        if (!$sales->getId()) {
            return false;
        }
