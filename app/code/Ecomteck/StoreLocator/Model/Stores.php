...
class Stores extends AbstractModel implements StoresInterface, RoutableInterface
{
    ...
    {
        return $this->setData(StoresInterface::IMAGE_1, $image_1);
    }
    ...
    {
        return $this->setData(StoresInterface::IMAGE_2, $image_2);
    }
    ...
    {
        return $this->setData(StoresInterface::IMAGE_3, $image_3);
    }
    ...
    {
        return $this->setData(StoresInterface::IMAGE_4, $image_4);
    }
    ...
    {
        return $this->setData(StoresInterface::IMAGE_5, $image_5);
    }
    ...
    public function setCommingSoon($comming_soon)
    {
        return $this->setData(StoresInterface::COMMING_SOON, $comming_soon);
    }

    public function setGoogleMap($google_map)
    {
        return $this->setData(StoresInterface::GOOGLE_MAP, $google_map);
    }

    public function setServiceIncluded($service_included)
    {
        return $this->setData(StoresInterface::SERVICE_INCLUDED, $service_included);
    }

    public function setOpeningHoursOne($opening_hours_one)
    {
        return $this->setData(StoresInterface::OPENING_HOURS_ONE, $opening_hours_one);
    }

    public function setOpeningHoursTwo($opening_hours_two)
    {
        return $this->setData(StoresInterface::OPENING_HOURS_TWO, $opening_hours_two);
    }

    public function getSkipDays()
    {
        return $this->getData(StoresInterface::SKIP_DAYS);
    }

    public function getCommingSoon()
    {
        return $this->getData(StoresInterface::COMMING_SOON);
    }

    public function getCutoffTime()
    {
        return $this->getData(StoresInterface::CUTOFF_TIME);
    }

    public function setCutoffTime($cutoffTime)
    {
        return $this->setData(StoresInterface::CUTOFF_TIME, $cutoffTime);
    }

    public function getSkipHours()
    {
        return $this->getData(StoresInterface::SKIP_HOURS);
    }

    public function setSkipHours($skipHours)
    {
        return $this->setData(StoresInterface::SKIP_HOURS, $skipHours);
    }
     ...
     * @return string
     */
    public function getOpeningHoursFormatedBKP()
    {
        if ($openingHours = $this->getOpeningHours()) {
            $html = [];
            $html[] = '<ul>';
                ...
                if (!empty($openingHours[$key])) {
                    ...
                    foreach ($timeSlots as $timeSlot) {
                        ...
                        if ($startHour && $endHour && $startMinute && $endMinute) {
                            ...
                            $startTime = $this->formatTime($startHour, $startMinute);
    ...
    public function getOpeningHoursFormated()
    {
        if ($openingHours = $this->getOpeningHours()) {
            ...
            $html[] = '<ul>';
            //$days = $this->localeList->getOptionWeekdays(true, true);
            $days = $this->getWeekdaysInEnglish();
            $timeSlotArray = array();
            foreach ($days as $key => $day) {
                $dayOfWeek = ucfirst($day['label']);
                if (!empty($openingHours[$key])) {
                    ...
                    foreach ($timeSlots as $timeSlot) {
                        ...
                        if ($startHour && $endHour && $startMinute && $endMinute) {
                            ...
                            $dateTimeStartToday = new \DateTime($currentDate . ' ' . $currentTime, new \DateTimeZone($timezone->getConfigTimezone()));
                            $dateTimeStartToday->setTimezone(new \DateTimeZone($timezone->getConfigTimezone()));
                            $currentday =  date('l');
...
// exit;
    ...
    public function getWeekdaysInEnglish()
    {
        $englishWeekdays = [
    ...
    {
        return $this->getData(StoresInterface::IMAGE_1);
    }
    ...
    {
        return $this->getData(StoresInterface::IMAGE_2);
    }
    ...
    {
        return $this->getData(StoresInterface::IMAGE_3);
    }
    ...
    {
        return $this->getData(StoresInterface::IMAGE_4);
    }
    ...
    {
        return $this->getData(StoresInterface::IMAGE_5);
    }
    ...
    private function formatTime($hour, $minute)
    {
        ...
        return $this->localeDate->date($time)->format('h:i a');
    }
}
