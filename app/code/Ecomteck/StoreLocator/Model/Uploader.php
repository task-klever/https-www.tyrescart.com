...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'ecomteck_storelocator/tmp/stores/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'ecomteck_storelocator/stores/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'ecomteck_storelocator/tmp/stores/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'ecomteck_storelocator/stores/file';
