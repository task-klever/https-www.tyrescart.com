...
class ReportInstance extends AbstractReport
{
    ...
    public function init()
    {
        ...
        $this->setTable($report->getTable())
            ...
            ->setSortOrders($report->getSortOrders())
            ->setIsSharingEnabled($report->getIsSharingEnabled())
            ->setShareIdentifier($report->getShareIdentifier())
            ->setReportIdentifier($report->getReportIdentifier())
            ->setFilters($report->getFilters() ?: [])
            ->setPageSize($report->getPageSize())
            ->setTimeRange($report->getTimeRange() ?: DateServiceInterface::THIS_MONTH);
