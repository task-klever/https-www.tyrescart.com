...
class ReportRepository implements ReportRepositoryInterface
{
    ...
    public function getByReportIdentifier(string $identifier)
    {
        $report = $this->getCollection()
            ->addFieldToFilter(ReportInterface::REPORT_IDENTIFIER, $identifier)
            ->getFirstItem();

        return $report && $report->getId() ? $report : null;
    }
