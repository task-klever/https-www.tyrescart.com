...
namespace Mirasvit\Sorting\Model\Config\Source\Factor\Alphanumeric;
...
class AttributeSource implements ArrayInterface
{
    ...
    public function toOptionArray()
    {
        ...
        $attributes = $this->attributeCollection->setEntityTypeFilter($entityTypeId)
            ->addFieldToFilter('frontend_input', ['text','textarea','texteditor'])
            ->addFieldToFilter('is_visible', true)
            ->addFieldToFilter('attribute_code', ['nin' => ['category_ids']]);
